              ...
              <div className="max-w-lg mx-auto lg:mx-0">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div className="flex items-center gap-3">
                    ...
                    <p className="font-medium text-slate-700">Real-time sync with Google Sheets</p>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="font-medium text-slate-700">Advanced analytics dashboard</p>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="font-medium text-slate-700">Enterprise-grade security</p>
                  </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <p className="font-medium text-slate-700">Team collaboration tools</p>
                  </div>
                </div>
              </div>
            </div>
