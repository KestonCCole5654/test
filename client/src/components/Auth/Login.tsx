      ...
      <div className="flex flex-1 flex-col items-center justify-center px-4">
        <div className="max-w-md w-full mx-auto mt-8 mb-4">
          <div className="bg-white rounded-lg p-6 mb-6 border border-gray-100">
            ...
            <p className="text-gray-700 text-center text-base mb-1">
              <span className="font-semibold text-green-700">SheetBills</span> is a professional invoicing platform built for seamless integration with Google Sheets. All your invoices and business data are securely managed in your own Google Drive.
            </p>
            <p className="text-gray-600 text-center text-sm">
              <span className="font-semibold">Why Google Login?</span> For your security and privacy, SheetBills uses Google authentication. This ensures only you can access your data, and enables direct, real-time connection to your Google Sheets—no extra accounts or passwords required.
            </p>
          </div>
          <Toaster />
          <Card className="w-full max-w-sm mx-auto border-0">
            <CardContent className="p-8">
              <h2 className="text-2xl font-bold text-center mb-6">Sign in to SheetBills</h2>
              {error && (
