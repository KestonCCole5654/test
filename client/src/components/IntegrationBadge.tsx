  ...
  return (
    <div className="flex items-center justify-center mb-8 w-full">
      <div className="relative group">
        ...
        <div className="flex items-center bg-white/90 backdrop-blur-sm rounded-2xl  hover:shadow-xs transition-all duration-300 px-6 shadow-none py-4 border border-gray-100/50 group-hover:border-gray-200/80">
